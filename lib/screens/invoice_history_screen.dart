...
// VERSÃO FINAL: Polimento visual aplicado.
...
class _InvoiceHistoryScreenState extends State<InvoiceHistoryScreen> with TickerProviderStateMixin {
  ...
  Future<void> _pagarSelecionados(BuildContext context) async {
    // Lógica de pagamento (sem alterações)
    if (!mounted) return;
  ...
  Widget _buildCustomTabs() { /* ... (sem alterações) ... */ 
    return Container(
  ...
  Widget _buildErrorState(String error) { /* ... (sem alterações) ... */ 
    return Center(
      child: Container(
  ...
  Widget _buildEmptyState() { /* ... (sem alterações) ... */ 
    return const Center(
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
  ...
  Map<String, dynamic> _getStatusInfo(String status) { /* ... (sem alterações) ... */ 
    switch (status) {
  ...
  Widget _buildInvoiceList(List<Mensalidade> mensalidades, {required bool isPending}) { /* ... (sem alterações) ... */ 
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Container(
                    padding: const EdgeInsets.all(24),
                    decoration: BoxDecoration(gradient: LinearGradient(colors: [primaryColor.withOpacity(0.1), accentColor.withOpacity(0.1)]), shape: BoxShape.circle),
  ...
  Widget _buildInvoiceCard(Mensalidade mensalidade, {required bool isPending}) { /* ... (sem alterações) ... */ 
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [ BoxShadow(color: isSelected ? primaryColor.withOpacity(0.2) : Colors.grey.withOpacity(0.1), blurRadius: isSelected ? 12 : 8, offset: const Offset(0, 4)) ],
      ),
      child: Material(
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(gradient: LinearGradient(colors: [primaryColor.withOpacity(0.1), accentColor.withOpacity(0.1)]), borderRadius: BorderRadius.circular(10)),
  ...
  Widget _buildPaymentFooter(BuildContext context) { /* ... (sem alterações) ... */ 
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: Colors.white,
